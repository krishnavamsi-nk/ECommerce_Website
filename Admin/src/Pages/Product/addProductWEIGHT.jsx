...
const AddProductWEIGHT = () => {
  ...
  const addUpdatedProductRAM = () => {
    if (itemid !== "") {
      editData(`/api/productWeight/${itemid}`, formfields).then((res) => {
        fetchDataFromApi("/api/productWeight").then((res) => {
          console.log("this is the RESMs", res);
          setProductRAM(res);
        });
  ...
  const addProductRAM = (e) => {
    ...
    fd.append("name", formfields.productWEIGHT);
    console.log("this is the form RAM:", formfields.productWEIGHT);
        ...
        >
          ...
          <div>
            ...
            >
              ...
              <StyledBreadcrumb
                component="a"
                href="/productWEIGHT/List"
                label="productWEIGHT"
                icon={<HomeIcon fontSize="small" />}
              />

              <StyledBreadcrumb
                label="productWEIGHT Upload"
                    ...
                    >
                      <div className="d-flex align-items-center todo">
                        <Button
                          color="success"
                          onClick={() => {
                            updateRAM(item.id, item.productWEIGHT);
                          }}
                        >
                          <FaRegEdit />
                        </Button>
