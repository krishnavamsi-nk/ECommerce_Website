...
const MyAccount = () => {
  ...
  return (
    <>
      <section className="section1 p-4 cart-page accountpaage">
        <div
          className="container"
                        ...
                        <div className="col-md-12">
                          <div className="form-group mt-2">
                            ...
                            <input
                              ...
                              className="w-100 p-3"
                              name="name"
                              value={formfields.name} // Correct binding
              ...
              <form action="" onSubmit={updatePassword}>
                <div className="col-md-12">
                  <div className="row">
                    <div className="col-md-12">
                      <div className="form-group mt-2">
                        <label htmlFor="pass">OldPassword:</label>
                        <input
